            ...
            <div class="text-box service-box bg-secondary h-full">
                <h4 class="fw-6 mtm-5">HOW TO INVEST</h4>
                                        <ul>
                                            ...
                                            <li><p><i class="fa fa-check-square"></i> -Send the duly completed form and evidence of payment to support@auxilliary tradexcapital.com</p></li><br>
                    ...
                    <a href="user/signup.html" class="btn">Start Banking On Land</a>
    </div>
...
<div class="container">
    <div class="row gutter-vr-30px align-items-center justify-content-between">
        ...
        <div class="col-lg-4 text-lg-right text-center">
            <div class="cta-btn">
                <a href="user/signup.html" class="btn btn-lg">Get Started</a>
            </div>
        </div>
    </div>
</div>
