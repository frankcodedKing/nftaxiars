    ...
    <div class="section section-x bg-primary tc-grey" style="padding-bottom: 0px;">
        <div class="container">
            ...
            <div class="row gutter-vr-30px">
                ...
                <div class="col-12">
                    <div class="faq-item bg-light">
                        <h4>How long does my deposit take before it can reflect on my Auxilliary Tradex Investments account
                            dashboard?</h4>
                ...
                <div class="col-12">
                    <div class="faq-item bg-light">
                        <h4>Is AAA CAPITAL and Auxilliary Tradex the same?</h4>
                        <p>AAA CAPITAL is group of companies which Auxilliary Tradex is under and most of the executives and
                            team of AAA CAPITAL works for auxilliary tradex CAPITAL. AAA CAPITAL serves as a Parent Company
                            and Affiliate.</p>
                    </div>
                </div>
                <div class="col-12">
                    <div class="faq-item bg-light">
                        <h4>Is it possible to visit the company office located at London?</h4>
