        ...
        <nav class="navbar navbar-expand-lg sticky-top change" id="navbar" >
            ...
            <div class="card card-body">
                ...
                <p class="card-text"> Through in-depth discussion Jeremy encourages us to
                    regularly focus on our goals in life and then to financially plan with
                     ...
                     Auxilliary Tradex investment is very client centred and professional and we would happily recommend their services to others.</p>
                <!-- <br> -->
          ...
          <div class="col-md-5">
            <div class="card card-body">
                ...
                <i class="fas fa-quote-left" style="text-align: left;color: purple;"></i>
                <p class="card-text">Since investing with Auxilliary Tradex,
          ...
          <div class="row">
            ...
            <div class="col-md-5">
              <div class="card card-body">
                  ...
                  <i class="fas fa-quote-left" style="text-align: left;color: purple;"></i>
                  <p class="card-text">Wow this is wonderfully, it works like magic. More grace to your elbow Auxilliary Tradex and Investment Platform.
            ...
            <div class="col-md-5">
              <div class="card card-body">
                  ...
                  <p class="card-text">I have been into many trading close to 4years now. Many strategy I have tried but all failed.
                       I got frustrated and was almost calling it quit. Little did I know that a Auxilliary Tradex existed and had auto trading....Thanks i stumbled on there facebook advert</p>
                  <!-- <br> -->
          ...
          <div class="row">
            ...
            <div class="col-md-5">
              <div class="card card-body">
                  ...
                  <i class="fas fa-quote-left" style="text-align: left;color: purple;"></i>
                  <p class="card-text">Auxilliary Tradex INVEST is the real deal. I could not believe my eyes when they paid me my returns and through it,
                       I paid my children's school fees and it also assisted me to take care of my domestic duties. GOD bless you Auxilliary Tradex </p>
                  <!-- <br> -->
