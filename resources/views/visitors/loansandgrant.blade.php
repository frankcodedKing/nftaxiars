        ...
        <div class="col-lg-8">
            <div class="text-block">
                ...
                <p class="lead">
                       ...
                       process! At auxilliary tradex Capital, we understand! Our investors want simple facts, honest answers
                       and competitive products.

DGS automatically offers loan services to investors with over $50,000 investment either in our normal Auxilliary Tradex financial
...
identity of the investor are duly confirmed by Auxilliary Tradex loan board.
...
GREAT INVESTING WITH Auxilliary Tradex FAMILY
                                        </p>
            </div>
        </div><!-- .col -->
    </div><!-- .row -->
