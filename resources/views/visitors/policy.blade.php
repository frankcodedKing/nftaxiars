    ...
    <div class="container">
        ...
        <div class="col-lg-8 text-center">
            <div class="section-head section-md">
                <h5 class="heading-xs dash dash-both">auxilliary tradex Capital</h5>
                <h2>Our Policy</h2>
        ...
        <div class="col-lg-8 text-center">
            <div class="section-head section-md">
                                    <h2>Contact Information</h2>
                                        <p>Auxilliary Tradex is glad to receive your comments concerning this "Privacy Policy". In case you think that Auxilliary Tradex does not follow the rules and violate this Statement, contact us at <a href='mailto:{{$compd? $compd->companyEmail : "coming soon"}}'>{{$compd? $compd->companyEmail : "coming soon"}}</a> We guarantee that we will take commercially reasonable efforts to discover and solve the problem.</p>
            </div>
        </div>
    </div>
    </div><!-- .container -->
