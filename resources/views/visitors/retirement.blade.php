    ...
    <div class="row justify-content-between align-items-center gutter-vr-30px">
        ...
        <div class="col-lg-5">
            <div class="text-block">
                ...
                <p class="lead">
                                        Saving for retirement can be a daunting task, but with a sound strategy, it’s well within reach. Auxilliary Tradex is here to
        ...
        <div class="col-12">
            <div class="text-box service-box bg-secondary h-full">
                <h4 class="fw-6 mtm-5">Quadruple Your Retirement Savings? Really?</h4>
                                        <p>
                                            Auxilliary Tradex study of worldwide retirement saving habits
