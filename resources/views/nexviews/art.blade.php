...
<div>
    ...
    <div class="mx-4 sm:mx-8 flex gap-[1rem] sm:gap-[1rem] mb-6">
        <div class="flex gap-1 sm:gap-2">
            ...
            <h3 class="text-[.9rem] font-semibold mt-[.2rem]">19</h3>
        </div>
        <div class="flex gap-1 sm:gap-2">
            <h3 class="text-[.9rem] mt-[.1rem]">Volume (ETH):</h3>
            <h3 class="text-[.9rem] font-semibold mt-[.2rem]">285.30 ETH</h3>
        </div>
        <div class="flex gap-1 sm:gap-2">
            <h3 class="text-[.9rem] mt-[.1rem]">Owners:</h3>
            <h3 class="text-[.9rem] font-semibold mt-[.2rem]">51</h3>
        </div>
    </div>
    <div class="mb-6 text-gray-700 w-full sm:w-[60rem] mx-auto sm:mx-[1rem] px-4 py-8">
        <h3 class="text-[1rem] font-bold mb-1">Dive into the World of Art NFTs 🎨</h3>
        <p class="text-[.9rem] font-semibold leading-relaxed">Step into a digital gallery where creativity meets technology. Each NFT is a one-of-a-kind masterpiece, 
            crafted by visionary artists, ready to be collected and appreciated in the ever-evolving realm of Web3. 
