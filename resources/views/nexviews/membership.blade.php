...
<div>
    ...
    <div class="mx-4 sm:mx-8 flex gap-[1rem] sm:gap-[1rem] mb-6">
        <div class="flex gap-1 sm:gap-2">
            ...
            <h3 class="text-[.9rem] font-semibold mt-[.2rem]">59</h3>
        </div>
        <div class="flex gap-1 sm:gap-2">
            <h3 class="text-[.9rem] mt-[.1rem]">Volume (ETH):</h3>
            <h3 class="text-[.9rem] font-semibold mt-[.2rem]">6.30 ETH</h3>
        </div>
        <div class="flex gap-1 sm:gap-2">
            <h3 class="text-[.9rem] mt-[.1rem]">Owners:</h3>
            <h3 class="text-[.9rem] font-semibold mt-[.2rem]">86</h3>
        </div>
    </div>
    <div class="mb-6 text-gray-700 w-full sm:w-[60rem] mx-auto sm:mx-[1rem] px-4 py-8">
        <h3 class="text-[1rem] font-bold mb-1">Unlock Exclusive Benefits with Membership NFTs 🎟️</h3>
        <p class="text-[.9rem] font-semibold leading-relaxed">Membership NFTs provide access to exclusive clubs, communities, and 
            special perks that enhance your experiences. These digital assets represent ownership in a membership, whether it’s for a club, 
            a private event, or premium content. Holders enjoy unique benefits and perks that are only available to NFT owners.</p>
    </div>
