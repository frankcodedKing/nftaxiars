...
<div>
    ...
    <div class="mx-4 sm:mx-8 flex gap-[1rem] sm:gap-[1rem] mb-6">
        <div class="flex gap-1 sm:gap-2">
            ...
            <h3 class="text-[.9rem] font-semibold mt-[.2rem]">91</h3>
        </div>
        <div class="flex gap-1 sm:gap-2">
            <h3 class="text-[.9rem] mt-[.1rem]">Volume (ETH):</h3>
            <h3 class="text-[.9rem] font-semibold mt-[.2rem]">80 ETH</h3>
        </div>
        <div class="flex gap-1 sm:gap-2">
            <h3 class="text-[.9rem] mt-[.1rem]">Owners:</h3>
            <h3 class="text-[.9rem] font-semibold mt-[.2rem]">10</h3>
        </div>
    </div>
    <div class="mb-6 text-gray-700 w-full sm:w-[60rem] mx-auto sm:mx-[1rem] px-4 py-8">
        <h3 class="text-[1rem] font-bold mb-1">Capture the World Through Photography NFTs 📸
🖼️
</h3>
        <p class="text-[.9rem] font-semibold leading-relaxed">Photography NFTs capture moments in time, allowing photographers to showcase their work as digital collectibles. 
            Whether it's nature, portraiture, or conceptual art, these NFTs represent the intersection of art and technology. 
            By owning a Photography NFT, you are preserving a piece of digital history that can be resold, exhibited, or used for personal inspiration.</p>
    </div>
